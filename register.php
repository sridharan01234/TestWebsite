		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Welcome To Our Family</h2>
				</div>
			</div>
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<button type="submit" value="Register" class="form-control btn btn-primary submit px-3">Sign Up</button>
	            </div>
	            	...
	            	<div class="w-50">
		            	<label class="checkbox-wrap checkbox-primary">Remember Me
								...
								<div class="w-50 text-md-right">
									<a href="index.php" style="color: #fff">Already a User</a>
								</div>
	            </div>
	          </form>
	          </div>
